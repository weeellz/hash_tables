...
template <class Key, class T, class Hash, class Allocator>
separate_chaining<Key, T, Hash, Allocator>::separate_chaining(size_t table_capacity) :
	//data_(allocator.allocate(table_capacity)),
	size_(table_capacity),
...
template <class Key, class T, class Hash, class Allocator>
separate_chaining<Key, T, Hash, Allocator>::separate_chaining(Allocator allocator) :
	allocator(allocator),
	//data_(allocator.allocate(initial_capacity)),
...
template <class Key, class T, class Hash, class Allocator>
Key separate_chaining<Key, T, Hash, Allocator>::insert(const Key& key, const T& value)
{
